...
const FIELDS = ["User_Story__c.Requirement__c", "User_Story__c.Acceptance_Criteria__c"];

export default class UserStorySummary extends LightningElement {
    @api recordId;
    @api objectApiName;
    ...
    wiredRecord({ error, data }) {
        ...
        this.dispatchEvent(
            ...
            this.requirement = this.userRecord.fields.Requirement__c.value;
