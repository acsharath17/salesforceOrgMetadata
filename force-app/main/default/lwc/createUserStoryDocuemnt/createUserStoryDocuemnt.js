...
const FIELDS = ["User_Story__c.Technical_Requirement__c", "User_Story__c.User_Story_Summary__c"];

export default class CreateUserStoryDocuemnt extends LightningElement {
    @api recordId;
    @api objectApiName;
    ...
    wiredRecord({ error, data }) {
        ...
        this.dispatchEvent(
            ...
            this.userStorySummary = this.userRecord.fields.User_Story_Summary__c.value;
            this.userQuery = '';
        }
    }
