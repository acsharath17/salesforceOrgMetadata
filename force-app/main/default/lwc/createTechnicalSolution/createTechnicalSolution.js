...
const FIELDS = ["User_Story__c.Technical_Requirement__c", "User_Story__c.Acceptance_Criteria__c"];

export default class CreateTechnicalSolution extends LightningElement {
    @api recordId;
    @api objectApiName;
    ...
    wiredRecord({ error, data }) {
        ...
        this.dispatchEvent(
            ...
            this.requirement = this.userRecord.fields.Technical_Requirement__c.value;
            this.acceptanceCriteria = this.userRecord.fields.Acceptance_Criteria__c.value;
            this.userQuery = this.requirement;
        }
    }
    ...
    handleSubmitv2(){
        ...
        openAiAnswer({userQuery:this.userQuery,recordId: this.recordId, type: this.type})
    }
    ...
    async handleButtonClick() {
        ...
        // Call the Apex method to invoke the Queueable job
            await openAiAnswer({userQuery:this.userQuery,recordId: this.recordId, type: this.type});
