...
const FIELDS = ["Metadata__c.Name", "Metadata__c.Metadata_Type__c"];

export default class MetadataSummary extends LightningElement {
    @api recordId;
    @api objectApiName;
    ...
    wiredRecord({ error, data }) {
        if (error) {
            ...
            this.userQuery = 'get '+this.metadataDataName+' from the context provided of type '+this.metadataType+' and create a detailed technical document explain it\'s functionality and usage.';
        }
    }
    ...
    handleSubmitv2(){
        ...
        openAiAnswer({userQuery:this.userQuery,recordId: this.recordId,type:'Metadata'})
    }
    ...
    async handleButtonClick() {
        ...
        // Call the Apex method to invoke the Queueable job
            ...
            await openAiAnswer({userQuery:this.userQuery,recordId: this.recordId, type:'Metadata'});
